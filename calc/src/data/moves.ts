...
const RBY: {[name: string]: MoveData} = {
  ...
  'Spike Cannon': {bp: 25, type: 'Water', multihit: [2, 5]},
  ...
  'Sky Attack': {bp: 140, type: 'Flying', hasCrashDamage: true},
