...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_MIND_READER] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user painfully reads the\n"
            "foes mind. Hurts the user."),
        .effect = EFFECT_RECOIL,
        .power = 120,
        .type = TYPE_PSYCHIC,
  ...
  [MOVE_HP_ICE] =
    ...
    [MOVE_TECTONIC_RAGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A rampage of that causes\n"
            "recoil to the the user."),
        .effect = EFFECT_RECOIL,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 120 : 90,
        .type = TYPE_GROUND,
        .accuracy = 100,
