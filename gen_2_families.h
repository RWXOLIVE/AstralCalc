...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_TYPHLOSION_HISUI, CONDITIONS({IF_IN_MAPSEC, MAPSEC_MT_PYRE})},
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_BATTLE_ARMOR, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_FLAAFFY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_ILLUMINATE, ABILITY_FLUFFY, ABILITY_FRIEND_GUARD },
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_ILLUMINATE, ABILITY_SHEER_FORCE, ABILITY_FRIEND_GUARD },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_COTTON_DOWN, ABILITY_COTTON_DOWN, ABILITY_INFILTRATOR },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_INFILTRATOR },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WOOPER_PALDEA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_POISON_POINT, ABILITY_POISON_POINT, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Wooper"),
        .cryId = CRY_WOOPER,
        .natDexNum = NATIONAL_DEX_WOOPER,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_RAZOR_FANG, SPECIES_GLISCOR, CONDITIONS({IF_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 0, SPECIES_GLISCOR, CONDITIONS({IF_TIME, TIME_NIGHT}, {IF_HOLD_ITEM, ITEM_RAZOR_FANG})}),
    #endif
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_RAZOR_CLAW, SPECIES_WEAVILE, CONDITIONS({IF_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 0, SPECIES_WEAVILE, CONDITIONS({IF_TIME, TIME_NIGHT}, {IF_HOLD_ITEM, ITEM_RAZOR_CLAW})}),
    #endif
    },
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .formSpeciesIdTable = sSneaselFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_RAZOR_CLAW, SPECIES_SNEASLER, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 0, SPECIES_SNEASLER, CONDITIONS({IF_NOT_TIME, TIME_NIGHT}, {IF_HOLD_ITEM, ITEM_RAZOR_CLAW})}),
    },
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_HONEY, SPECIES_URSALUNA, CONDITIONS({IF_TIME, TIME_NIGHT})},
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_MANTINE}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SHEER_FORCE, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SKARMORY_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_STALWART, ABILITY_NONE, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Skarmory"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_SOLAR_POWER, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Houndoom"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_TECHNICIAN, ABILITY_MOODY },
    #else
